 ...
 *
 * Backward-compatible with EBN_Widget v1.x:
 *  - get_name()  → 'ebn_bottom_nav'  (unchanged)
 *  - CSS handle  → 'ebn-style'       (unchanged)
 *  - JS  handle  → 'ebn-script'      (unchanged)
...
class Paradise_Bottom_Nav_Widget extends Widget_Base {
    ...
    public function get_name():       string { return 'ebn_bottom_nav'; }
    public function get_title():      string { return 'Bottom Navigation Bar'; }
    public function get_icon():       string { return 'eicon-nav-menu'; }
    public function get_categories(): array  { return [ 'paradise' ]; }
    public function get_keywords():   array  { return [ 'bottom', 'nav', 'mobile', 'menu', 'navigation', 'bar', 'tab' ]; }
    ...
    private function section_visibility(): void {
        ...
        $this->add_responsive_control( 'bar_display', [
            ...
            'selectors'        => [
                '{{WRAPPER}} .ebn-wrapper' => 'display: {{VALUE}};',
            ],
    ...
    private function section_style_bar(): void {
        ...
        $this->add_control( 'bar_max_width', [
            ...
            'selectors'  => [ '{{WRAPPER}} .ebn-wrapper' => 'max-width: {{SIZE}}{{UNIT}};' ],
        ...
        $this->add_control( 'bar_bottom_offset', [
            ...
            'selectors'  => [ '{{WRAPPER}} .ebn-wrapper' => 'bottom: {{SIZE}}px;' ],
            'condition'  => [ 'bar_position' => 'floating' ],
        ] );
        ...
        $this->add_control( 'bar_bg', [
            ...
            'default'   => '#ffffff',
            'selectors' => [ '{{WRAPPER}} .ebn-bar' => 'background-color: {{VALUE}};' ],
            'separator' => 'before',
        ] );

        $this->add_group_control( Group_Control_Border::get_type(), [
            'name'     => 'bar_border',
            'selector' => '{{WRAPPER}} .ebn-bar',
            'fields_options' => [
        ...
        $this->add_control( 'bar_radius', [
            ...
            'selectors'  => [
                '{{WRAPPER}} .ebn-bar'     => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                '{{WRAPPER}} .ebn-wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ] );
    ...
    private function section_style_items(): void {
        ...
        $this->add_control( 'icon_size', [
            ...
            'selectors'  => [
                '{{WRAPPER}} .ebn-item i'   => 'font-size: {{SIZE}}px;',
                '{{WRAPPER}} .ebn-item svg' => 'width: {{SIZE}}px; height: {{SIZE}}px;',
            ],
        ] );
        ...
        $this->add_control( 'icon_label_gap', [
            ...
            'selectors'  => [ '{{WRAPPER}} .ebn-item' => 'gap: {{SIZE}}px;' ],
        ] );

        $this->add_group_control( Group_Control_Typography::get_type(), [
            'name'     => 'label_typography',
            'label'    => 'Label Typography',
            'selector' => '{{WRAPPER}} .ebn-label',
            'fields_options' => [
        ...
        $this->add_control( 'icon_color', [
            ...
            'default'   => '#b0bec5',
            'selectors' => [
                '{{WRAPPER}} .ebn-item:not(.ebn-item--active) i'   => 'color: {{VALUE}};',
                '{{WRAPPER}} .ebn-item:not(.ebn-item--active) svg' => 'color: {{VALUE}}; fill: {{VALUE}};',
            ],
        ] );
        $this->add_control( 'label_color', [
            ...
            'type'      => Controls_Manager::COLOR,
            'default'   => '#b0bec5',
            'selectors' => [ '{{WRAPPER}} .ebn-item:not(.ebn-item--active) .ebn-label' => 'color: {{VALUE}};' ],
        ] );
        ...
        $this->add_control( 'icon_color_active', [
            ...
            'default'   => '#F5A623',
            'selectors' => [
                '{{WRAPPER}} .ebn-item--active i'   => 'color: {{VALUE}};',
                '{{WRAPPER}} .ebn-item--active svg' => 'color: {{VALUE}}; fill: {{VALUE}};',
            ],
        ] );
        $this->add_control( 'label_color_active', [
            ...
            'type'      => Controls_Manager::COLOR,
            'default'   => '#F5A623',
            'selectors' => [ '{{WRAPPER}} .ebn-item--active .ebn-label' => 'color: {{VALUE}};' ],
        ] );
        $this->end_controls_tab();
    ...
    private function section_style_indicator(): void {
        ...
        $this->add_control( 'indicator_color', [
            ...
            'default'   => '#F5A623',
            'selectors' => [
                '{{WRAPPER}} .ebn-indicator'                    => 'background-color: {{VALUE}};',
                '{{WRAPPER}} .ebn-item--active .ebn-dot'       => 'background-color: {{VALUE}};',
                '{{WRAPPER}} .ebn-item--active.ebn-pill'       => 'background-color: {{VALUE}}1a;',
                '{{WRAPPER}} .ebn-item--active .ebn-item-icon' => 'filter: drop-shadow(0 0 6px {{VALUE}});',
            ],
        ...
        $this->add_control( 'indicator_size', [
            ...
            'selectors'  => [
                '{{WRAPPER}} .ebn-indicator' => 'width: {{SIZE}}px;',
                '{{WRAPPER}} .ebn-dot'       => 'width: {{SIZE}}px; height: {{SIZE}}px;',
            ],
    ...
    private function section_style_badge(): void {
        ...
        $this->add_control( 'badge_bg', [
            ...
            'type'      => Controls_Manager::COLOR,
            'default'   => '#e53935',
            'selectors' => [ '{{WRAPPER}} .ebn-badge' => 'background-color: {{VALUE}};' ],
        ] );
        ...
        $this->add_control( 'badge_text_color', [
            ...
            'type'      => Controls_Manager::COLOR,
            'default'   => '#ffffff',
            'selectors' => [ '{{WRAPPER}} .ebn-badge' => 'color: {{VALUE}};' ],
        ] );
        ...
        $this->add_control( 'badge_size', [
            ...
            'default'    => [ 'unit' => 'px', 'size' => 16 ],
            'selectors'  => [
                '{{WRAPPER}} .ebn-badge' => 'min-width: {{SIZE}}px; height: {{SIZE}}px; font-size: calc({{SIZE}}px * 0.625);',
            ],
        ] );
    ...
    private function section_style_center(): void {
        ...
        $this->add_control( 'center_size', [
            ...
            'selectors'  => [ '{{WRAPPER}} .ebn-center-btn' => 'width: {{SIZE}}px; height: {{SIZE}}px;' ],
        ] );
        ...
        $this->add_control( 'center_bg', [
            ...
            'type'      => Controls_Manager::COLOR,
            'default'   => '#F5A623',
            'selectors' => [ '{{WRAPPER}} .ebn-center-btn' => 'background-color: {{VALUE}};' ],
        ] );
        ...
        $this->add_control( 'center_icon_color', [
            ...
            'default'   => '#ffffff',
            'selectors' => [
                '{{WRAPPER}} .ebn-center-btn i'   => 'color: {{VALUE}};',
                '{{WRAPPER}} .ebn-center-btn svg' => 'color: {{VALUE}}; fill: {{VALUE}};',
            ],
        ] );
        ...
        $this->add_control( 'center_icon_size', [
            ...
            'default'    => [ 'unit' => 'px', 'size' => 22 ],
            'selectors'  => [
                '{{WRAPPER}} .ebn-center-btn i'   => 'font-size: {{SIZE}}px;',
                '{{WRAPPER}} .ebn-center-btn svg' => 'width: {{SIZE}}px; height: {{SIZE}}px;',
            ],
        ] );
        ...
        $this->add_control( 'center_lift', [
            ...
            'selectors'  => [ '{{WRAPPER}} .ebn-center-wrap' => 'transform: translateY(-{{SIZE}}px);' ],
        ] );

        $this->add_group_control( Group_Control_Box_Shadow::get_type(), [
            'name'     => 'center_shadow',
            'selector' => '{{WRAPPER}} .ebn-center-btn',
            'fields_options' => [
                'box_shadow_type' => [ 'default' => 'yes' ],
    ...
    protected function render(): void {
        ...
        $wrapper_classes = implode( ' ', array_filter( [
            'ebn-wrapper',
            'ebn-pos-' . esc_attr( $bar_pos ),
            $is_edit ? 'ebn-is-editor' : '',
        ] ) );
        ...
        <nav class="<?php echo $wrapper_classes; ?>"
             ...
             data-ebn='<?php echo wp_json_encode( $data ); ?>'>
            ...
            <div class="ebn-bar">
                ...
                if ( in_array( $ind, [ 'top_bar', 'bot_bar' ], true ) ) : ?>
                    <div class="ebn-indicator ebn-indicator--<?php echo esc_attr( $ind ); ?>" aria-hidden="true"></div>
                <?php endif;
                ...
                if ( $source === 'repeater' ) {
                    ...
                    foreach ( $items as $i => $item ) :
                        if ( $center_on && $i === $mid ) $this->render_center_btn( $s, $show_labels, $center_act );
                        $this->render_item_repeater( $item, $show_labels, $current_url, $s );
                    endforeach;
                    if ( $center_on && $mid >= $total ) $this->render_center_btn( $s, $show_labels, $center_act );
                } else {
                    $slug  = $s['wp_menu_slug'] ?? '';
            ...
            <?php if ( $center_on && $center_act === 'speed_dial' ) :
                ...
                $dial_classes = 'ebn-speed-dial' . ( $is_edit ? ' ebn-speed-dial--open' : '' );
                    ...
                    ?>
                        <a href="<?php echo esc_url( $d_url ?: '#' ); ?>"
                           ...
                           <?php echo $d_ext ? 'target="_blank" rel="noopener noreferrer"' : ''; ?>>
                            <span class="ebn-dial-icon" aria-hidden="true">
                                <?php Icons_Manager::render_icon( $dial['dial_icon'], [ 'aria-hidden' => 'true' ] ); ?>
                            </span>
                            <span class="ebn-dial-label"><?php echo esc_html( $dial['dial_label'] ); ?></span>
                        </a>
                    <?php endforeach; ?>
                </div>
            <?php endif; ?>
    ...
    private function render_badge( array $item ): void {
        if ( ( $item['badge_enabled'] ?? 'no' ) !== 'yes' ) return;
        ...
        $data_attrs = $source === 'js' ? ' data-ebn-badge-target="' . esc_attr( $css_id ) . '"' : '';

        printf(
            '<span class="ebn-badge"%s%s>%s</span>',
            $hide_attr,
            $data_attrs,
    ...
    private function render_item_repeater( array $item, bool $show_labels, string $current_url, array $s ): void {
        ...
        $classes = 'ebn-item';
        if ( $active )              $classes .= ' ebn-item--active';
        if ( $ind_style === 'pill') $classes .= ' ebn-pill';
        ?>
        <a<?php echo $id_attr; ?>
           ...
           aria-current="<?php echo $active ? 'page' : 'false'; ?>">
            <span class="ebn-item-icon" aria-hidden="true">
                <?php Icons_Manager::render_icon( $item['item_icon'], [ 'aria-hidden' => 'true' ] ); ?>
                <?php $this->render_badge( $item ); ?>
            </span>
            <?php if ( $ind_style === 'dot' ) : ?>
                <span class="ebn-dot" aria-hidden="true"></span>
            <?php endif; ?>
            <?php if ( $show_labels ) : ?>
                <span class="ebn-label"><?php echo esc_html( $item['item_label'] ); ?></span>
            <?php endif; ?>
        </a>
        <?php
    }
    ...
    private function render_item_wp_menu( object $item, bool $show_labels, string $current_url ): void {
        ...
        <a href="<?php echo esc_url( $url ); ?>"
           class="ebn-item<?php echo $active ? ' ebn-item--active' : ''; ?>"
           aria-current="<?php echo $active ? 'page' : 'false'; ?>">
            <span class="ebn-item-icon" aria-hidden="true">
                <?php Icons_Manager::render_icon( $icon_data, [ 'aria-hidden' => 'true' ] ); ?>
            </span>
            <?php if ( $show_labels ) : ?>
                <span class="ebn-label"><?php echo esc_html( $item->title ); ?></span>
            <?php endif; ?>
        </a>
        <?php
    }
    ...
    private function render_center_btn( array $s, bool $show_labels, string $center_act ): void {
        ...
        switch ( $center_act ) {
            case 'link':
                ...
                $data_attr = 'data-ebn-action="link"';
                break;
            case 'js_hook':
                $tag       = 'button';
                $href_attr = 'type="button"';
                $ext_attr  = '';
                $data_attr = 'data-ebn-action="js_hook" data-ebn-hook="' . esc_attr( $hook ) . '"';
                break;
            default:
                $tag       = 'button';
                $href_attr = 'type="button"';
                $ext_attr  = '';
                $data_attr = 'data-ebn-action="speed_dial"';
        }
        ?>
        <div class="ebn-center-wrap">
            <<?php echo $tag; ?> <?php echo $href_attr; ?> <?php echo $ext_attr; ?> <?php echo $data_attr; ?>
                class="ebn-center-btn"
                aria-label="<?php echo esc_attr( $label ); ?>"
                aria-expanded="false">
                <span class="ebn-center-icon" aria-hidden="true">
                    <?php Icons_Manager::render_icon( $s['center_icon'], [ 'aria-hidden' => 'true' ] ); ?>
                </span>
            </<?php echo $tag; ?>>
            <?php if ( $show_labels && $label ) : ?>
                <span class="ebn-label ebn-center-label"><?php echo esc_html( $label ); ?></span>
            <?php endif; ?>
        </div>
        <?php
    }
    ...
    private function get_wp_menus(): array {
        ...
        $result = [ '' => '— Select —' ];
        foreach ( $menus as $menu ) $result[ $menu->slug ] = $menu->name;
        return $result;
    }
